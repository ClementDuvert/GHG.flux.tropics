...
T.Pressure=a';
T.Pressure(~isnan(T.Elevation))=(1-(.0000225577.*T.Elevation(~isnan(T.Elevation)))).^5.25588; %for those data where we have elevation, recalculate pressure

% Henry constant calculation (in mol/L/atm)
T.Temp_gapfill=T.Temperature;
a=repelem(20,size(T,1)); %if temperature is not reported, assign temperature
b=isnan(T.Temp_gapfill); T.Temp_gapfill(b)=a(b);
totalFilled=sum(b);
...
% make the 'CO2 method' variable categorical
...
units_gm2d={'g C m-2 d-1','gC m-2 d-1','g/m2/d','g C/m2/d','g m-2 d-1','g CO2-C m-2 d-1','gC/m2d'}';
fco2_5=cellfun(@(c)strcmp(c,units_gm2d),T.F_CO2_units,'UniformOutput',false);
units_mgm2d={'mg C m-2 d-1','mg/m2/d','mg C/m2/d','mg m-2 d-1','mgC m-2 d-1'}';
...
units_molm2d={'mol C/m2/d','mol/m2/d'}';
...
units_gm2d={'g C m-2 d-1','gC m-2 d-1','g/m2/d','g C/m2/d','g m-2 d-1','gC/m2d'}';
fch4_5=cellfun(@(c)strcmp(c,units_gm2d),T.F_CH4_units,'UniformOutput',false);
units_mgm2d={'mg C m-2 d-1','mg/m2/d','mg C/m2/d','mg m-2 d-1','mgC m-2 d-1','mg C m_2 d_1','mg/m2/day','mg/m^2/day','mg CH4-C m-2 d-1'}';
...
if ismember('FN2O_UNITS',T.Properties.VariableNames)==1
    ...
    units_mgm2d={'mg/m2/day','mg N m-2 d-1','mg/m2/d'}';
    fn2o_2=cellfun(@(c)strcmp(c,units_mgm2d),T.FN2O_UNITS,'UniformOutput',false);
    units_mgN2Om2d={'mg N2O m-2 day-1'};
